    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                <Card className="metric-card bg-gradient-to-br from-slate-50 to-slate-100">
                ...
                <Card className="metric-card bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200">
                    <CardContent className="p-4">
                        <div className="flex flex-col items-center gap-2 text-center">
                ...
                <Card className="metric-card bg-gradient-to-br from-red-50 to-red-100 border-red-200">
                    <CardContent className="p-4">
                        <div className="flex flex-col items-center gap-2 text-center">
                ...
                <Card className="metric-card bg-gradient-to-br from-rose-50 to-rose-100 border-rose-200">
                    <CardContent className="p-4">
                        <div className="flex flex-col items-center gap-2 text-center">
